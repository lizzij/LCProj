...
def sat_task1(args, writer=None):
    # data
    G, labels, name = gengraph.gen_sat1(
...
def sat_task2(args, writer=None):
    # data
    G, labels, name = gengraph.gen_sat2()
...
def sat_task3(args, writer=None):
    # data
    G, labels, name = gengraph.gen_sat3(
        feature_generator=featgen.ConstFeatureGen(np.ones(args.input_dim, dtype=float))
    )
    print(labels)
    num_classes = max(labels) + 1
...
def sat_task4(args, writer=None):
    # data
    G, labels, name = gengraph.gen_sat4(
        feature_generator=featgen.ConstFeatureGen(np.ones(args.input_dim, dtype=float))
    )
    print(labels)
    num_classes = max(labels) + 1
...
def sat_task5(args, writer=None):
    # data
    G, labels, name = gengraph.gen_sat5(
        feature_generator=featgen.ConstFeatureGen(np.ones(args.input_dim, dtype=float))
    )
    print(labels)
...
def main():
    ...
    if prog_args.bmname is not None:
        ...
        if prog_args.dataset == "sat1":
            sat_task1(prog_args, writer=writer)
        elif prog_args.dataset == "sat2":
            sat_task2(prog_args, writer=writer)
        elif prog_args.dataset == "sat3":
            sat_task3(prog_args, writer=writer)
        elif prog_args.dataset == "sat4":
            sat_task4(prog_args, writer=writer)
        elif prog_args.dataset == "sat5":
            sat_task5(prog_args, writer=writer)
