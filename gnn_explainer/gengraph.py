"""gengraph.py
   ...
   Generating and manipulaton the sat graphs needed for the paper's experiments.
"""
...
def gen_sat2(nb_shapes=100, width_basis=350):
    """ Sat Graph #2:
    ...
    G1, role_id1, name = gen_sat1(feature_generator=feat_gen_G1, m=4)
    G2, role_id2, name = gen_sat1(feature_generator=feat_gen_G2, m=4)
...
def gen_sat3(nb_shapes=80, width_basis=300, feature_generator=None, m=5):
    """ Sat Graph #3:
    ...
    Returns:
        G                 :  A networkx graph
        role_id           :  Role ID for each node in satthetic graph.
        name              :  A graph identifier
    """
    basis_type = "ba"
...
def gen_sat4(nb_shapes=60, width_basis=8, feature_generator=None, m=4):
    """ Sat Graph #4:
    ...
    path = os.path.join("log/sat4_base_h20_o20")
...
def gen_sat5(nb_shapes=80, width_basis=8, feature_generator=None, m=3):
    """ Sat Graph #5:
    ...
    path = os.path.join("log/sat5_base_h20_o20")
    writer = SummaryWriter(path)
